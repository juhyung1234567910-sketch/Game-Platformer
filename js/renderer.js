...
export class Renderer {
  ...
  _buildWorld() {
    ...
    const boxes = [
      ...
      // 1. 거대 구역으로 이어지는 징검다리 구간 (고도를 서서히 높임)
      [0, 24, 178,   4, 0.5, 4,    0x7fa0b3, 'solid'],
      [0, 25, 186,   3, 0.5, 3,    0x7fa0b3, 'solid'],
      [0, 26, 194,   3, 0.5, 3,    0x7fa0b3, 'solid'],

      // 2. 중간 아레나 구역 (폭이 넓은 휴식터 겸 탐험 구역)
      [0, 27, 215,   35, 1, 35,    0x4d6659, 'checker'], // 넓은 녹색 계열 체크무늬 바닥
      [-25, 31, 215, 2, 8, 2,      0x88aa99, 'stripe'],  // 아레나 왼쪽 기둥
      [25, 31, 215,  2, 8, 2,      0x88aa99, 'stripe'],  // 아레나 오른쪽 기둥
      [0, 31, 195,   2, 8, 2,      0x88aa99, 'stripe'],  // 아레나 입구 기둥
      [0, 29, 215,   6, 3, 6,      0x33e699, 'noise'],   // 아레나 중앙의 신비로운 조형물
      [0, 33, 215,   2, 2, 2,      0xffffff, 'noise'],   // 조형물 위 장식

      // 3. 지그재그 고공 등반 구간
      [10, 29, 235,  4, 0.2, 4,    0xe6e61a, 'solid'],
      [20, 31, 245,  4, 0.2, 4,    0xe6e61a, 'solid'],
      [10, 33, 255,  4, 0.2, 4,    0xe6e61a, 'solid'],
      [0, 35, 265,   4, 0.2, 4,    0xe6e61a, 'solid'],
      [-10, 37, 275, 4, 0.2, 4,    0xe6e61a, 'solid'],
      [-20, 39, 285, 4, 0.2, 4,    0xe6e61a, 'solid'],
      [-10, 41, 295, 4, 0.2, 4,    0xe6e61a, 'solid'],

      // 4. 최종 보스 룸 / 거대 신전 구역 (매우 넓고 웅장함)
      [0, 42, 320,   60, 2, 60,    0x1a1a24, 'checker'], // 엄청나게 큰 흑요석 느낌의 바닥
      [-40, 55, 280, 5, 25, 5,     0xcc3333, 'stripe'],  // 거대 신전 기둥 (좌전방)
      [40, 55, 280,  5, 25, 5,     0xcc3333, 'stripe'],  // 거대 신전 기둥 (우전방)
      [-40, 55, 360, 5, 25, 5,     0xcc3333, 'stripe'],  // 거대 신전 기둥 (좌후방)
      [40, 55, 360,  5, 25, 5,     0xcc3333, 'stripe'],  // 거대 신전 기둥 (우후방)
      
      // 신전 중앙 제단 및 구조물
      [0, 44, 320,   15, 2, 15,    0x333344, 'solid'],   // 제단 1단
      [0, 46, 320,   10, 2, 10,    0x444455, 'solid'],   // 제단 2단
      [0, 50, 320,   4, 8, 4,      0xffaa00, 'noise'],   // 제단 중앙의 코어 조형물
      [0, 55, 320,   8, 1, 8,      0xffcc00, 'solid']    // 코어 위를 덮는 황금 지붕
];
